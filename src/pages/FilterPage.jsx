        ...
        <div className="lg:w-3/4 w-full">
          ...
          <div className="grid md:grid-cols-2 gap-2">
            {data?.map((item, i) => (
              <div
                key={i}
                className="card bg-secondary_color rounded py-3 pl-2 pr-3 grid 2xl:grid-cols-2 gap-3 hover:cursor-pointer transition-all hover:scale-95 hover:shadow-lg"
              >
                <div className="flex flex-col gap-1">
                  <div className="h-1/2 overflow-hidden">
                    <img
                      className="w-full aspect-[1.3] min-h-32 max-h-44"
                      src="/images/image.png"
                      alt="main"
                    />
                  </div>

                  <div className="w-full max-h-28 h-1/2">
                    <Carousel
                      swipeable={false}
                      draggable={false}
                      showDots={false}
                    ...
                    >
                      <img src="/images/mini1.png" className="w-full h-full" />
                    </Carousel>
                  </div>
                </div>
